...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ("firstname","lastname","address","email","phone_number","age","gender","nationality","proile_picture", "martialStatus","employment_status","signature")
    search_fields = ("firstname","lastname","address","email","phone_number","age","gender","nationality","proile_picture", "martialStatus","employment_status","signature")
